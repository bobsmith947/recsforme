...
<html>
  ...
  <body>
    ...
    <main>
      <form data-bind="submit:sendInfo" id="info-form" method="POST" onsubmit="this.preventDefault()">
        ...
        <h5 class="text-info">Optional Fields</h5>
        <div class="form-group">
      ...
      <h5 class="text-info">Privacy Policy and Terms</h5>
      <pre class="text-light">
        By accepting these terms, you agree to be bound be them.
        
        1) You will hold one (1) account. Anyone found in possession of multiple accounts will have their access revoked.
        2) The information you submit is entirely accurate. Submitting false information only harms the service provided to you.
        3) You hold all liability for the information you submit, and will not take legal action against the owner of recsforme under any circumstance.
        4) To the end of 3), information stored by recsforme is not guaranteed to be immune to breaches, although all necessary steps are taken to minimize the risk of a breach.
        5) The service is provided to you as is, with no warranty or insurance.
        6) The owner of recsforme reserves all rights in accordance with the Apache License 2.0 (below).
<span>
                                                       Apache License
      ...
      <div class="form-check">
        <input data-bind="checked:read" type="checkbox" class="form-check-input" id="read">
        <label class="form-check-label" for="read">
          I've read the privacy policy and terms in their entirety.
        </label>
      </div>
      <div class="form-check">
      ...
      <button data-bind="enable:completed()" type="submit" class="btn btn-primary btn-lg btn-block mt-3" disabled form="info-form">
        Sign Up
      </button>
    </main>
  </body>
