...
<html>
  <head>
    ...
    <meta name="description" content="recsforme (recs for me) is an open source Java web application for media recommendations. This page represents a resource that doesn't exist.">
