...
public class Generator {
	...
	/**
	 * Creates an instance with an empty list of users and no known likes or dislikes. Not very helpful for making recommendations.
	 */
	public Generator() {
		users = new ArrayList<>();
		knownLikes = null;
	...
	/**
	 * Calculates the similarity between two pairs of lists. Both parameters are expected to be length two arrays. The first index should be the like list and the second index should be the dislike
	 * list. A result of 1.0 means the two pairs of lists are exactly the same. A result of -1.0 means the two pairs of lists are completely opposite.
	 *
	...
	/**
	 * Ranks the list of users based on their similarity to the known likes and dislikes. The list will be sorted in descending order.
	 */
